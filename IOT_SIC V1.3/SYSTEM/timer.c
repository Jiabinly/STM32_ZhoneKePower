...
void TIM_Configuration(void) {
  ...
  } else if (ULTRAFREZ == ULTRAFRE75) {
    TIM_TimeBaseStructure.TIM_Period = 239; // 36000/240/2=75khz
  } else if (ULTRAFREZ == ULTRAFRE40) {
    TIM_TimeBaseStructure.TIM_Period = 449; // 36000/450/2=40khz
  } else if (ULTRAFREZ == ULTRAFRE22) {
    TIM_TimeBaseStructure.TIM_Period = 817; // 36000/818/2=22khz
  } else {
